import type { ZungQuestion } from '../interface/forms';

export const zungQuestions: ZungQuestion[] = [
   { id: 1, text: "Tôi cảm thấy nóng này và lo âu hơn thường lệ." },
  { id: 2, text: "tôi cảm thấy sự vô cơ." },
  ...
  { id: 9, text: "Tôi cảm thấy bình tĩnh và có thể ngồi yên 1 cách dễ dàng." },
  ...
  { id: 13, text: "Tôi có thể thở ra, hít vào 1 cách dễ dàng." },
